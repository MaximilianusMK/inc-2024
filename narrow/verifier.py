...
def main(argv):
  ...
  Cs = vr.ReadInt(0, 1000)
  vr.ReadSpace()
  Cw = vr.ReadInt(0, 1000)
  vr.ReadSpace()
  Cd = vr.ReadInt(0, 1000)
  vr.ReadEndl()

  Ps = vr.ReadInt(1, 100000)
  vr.ReadSpace()
  Pw = vr.ReadInt(1, 100000)
  vr.ReadSpace()
  Pd = vr.ReadInt(1, 100000)
  vr.ReadEndl()

  S1 = vr.ReadString(".#", N, N)
  vr.ReadEndl()
  S2 = vr.ReadString(".#", N, N)
  vr.ReadEndl()
  vr.ReadEof()
